...
//   // Разбиваем заголовок на буквы, но "Витебске" не разбиваем
...
//       {/* Услуги - баннеры как на старом сайте: 2 + 2 + 3 */}
//       <section
//         id="services"
//         className="services"
...
export default function Home() {
  ...
  // SEO: устанавливаем заголовок страницы
  useEffect(() => {
