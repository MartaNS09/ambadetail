              ...
              {titleParts.map((part, partIndex) => (
                ...
                >
                  {part.split("").map((letter, letterIndex) => (
                    <span
                      key={letterIndex}
                      className={`about-hero__title-letter ${
                        isVisible ? "about-hero__title-letter--visible" : ""
                      }`}
                      style={{
          ...
          <div className="about-main">
            <div
              ...
              className={`about-main__text ${
                isMainAnimated ? "about-main__text--animate" : ""
              }`}
            >
            ...
            <div
              ref={imagesRef}
              className={`about-main__images ${
                isImagesAnimated ? "about-main__images--animate" : ""
              }`}
            >
            ...
            {stats.map((stat, index) => (
              <div
                ...
                className={`about-stats__item ${
                  isStatsVisible ? "about-stats__item--animate" : ""
                }`}
