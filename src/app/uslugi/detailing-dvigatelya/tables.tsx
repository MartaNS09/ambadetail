        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="text-left">
              ...
              <small>
                <em>
                  За работу двигателя и других систем и агрегатов после мойки
                  подкапотного пространства компания ответственности не несет
                </em>
              </small>
            </td>
            <td className="price">151</td>
            <td className="price">151</td>
            <td className="price">264</td>
            <td className="price">264</td>
            <td className="price">264</td>
          </tr>
          <tr>
            ...
            <td className="text-left">
              Глубокая очистка радиатора (со снятием бампера)
            </td>
            <td className="price">от 302</td>
            <td className="price">от 415</td>
            <td className="price">от 415</td>
            <td className="price">от 415</td>
            <td className="price">от 415</td>
          </tr>
          <tr>
            ...
            <td className="text-left">
              Мойка подвески и днища (без снятия бамперов)
            </td>
            <td className="price">528</td>
            <td className="price">528</td>
            <td className="price">754</td>
            <td className="price">754</td>
            <td className="price">754</td>
          </tr>
          <tr>
            ...
            <td className="text-left">
              Мойка подвески и днища (со снятием бамперов)
            </td>
            <td className="price">641</td>
            <td className="price">641</td>
            <td className="price">943</td>
            <td className="price">943</td>
            <td className="price">943</td>
          </tr>
