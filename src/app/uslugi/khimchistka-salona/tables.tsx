      ...
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ДЕТЕЙЛИНГ ХИМЧИСТКА АВТОМОБИЛЯ</strong>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="text-left">Руль</td>
          ...
          <tr>
            ...
            <td className="text-left">Карта одной двери</td>
          ...
          <tr>
            ...
            <td className="text-left">Подлокотник</td>
            <td className="price" colSpan={5}>
              19
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Стойка крыши (2 шт.)</td>
            <td className="price" colSpan={5}>
              33
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Переднее сидение:</td>
          </tr>
          <tr>
            <td className="text-left">8</td>
            <td className="text-left">Текстиль (1 кресло)</td>
            <td className="price" colSpan={5}>
              от 33
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Темная кожа (1 кресло)</td>
            <td className="price" colSpan={5}>
              от 33
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Светлая кожа (1 кресло)</td>
            <td className="price" colSpan={5}>
              от 39
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="text-left">Багажник</td>
            <td className="price">от 59</td>
            <td className="price">от 67</td>
            <td className="price" colSpan={3}>
              от 76
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">
              Потолок (вкл. солнцезащитные козырьки)
            </td>
            <td className="price">от 72</td>
            <td className="price" colSpan={2}>
              от 96
            </td>
            <td className="price" colSpan={2}>
          ...
          <tr>
            ...
            <td className="text-left">Ковровое покрытие пола салона</td>
            <td className="price">от 72</td>
            <td className="price" colSpan={2}>
              от 72
            </td>
            <td className="price">от 96</td>
            <td className="price">от 119</td>
          </tr>
          <tr>
            <td className="text-left">18</td>
            <td className="text-left">
              Ковровое покрытие пола салона (с разбором)
            </td>
            <td className="price">от 96</td>
            <td className="price">от 119</td>
            <td className="price">от 133</td>
            <td className="price">от 143</td>
            <td className="price">от 167</td>
          </tr>
          <tr>
            <td className="text-left">19</td>
            <td className="text-left">
              Ковровое покрытие пола салона (1 место)
            </td>
            <td className="price" colSpan={3}>
              от 24
            </td>
          ...
          <tr>
            ...
            <td className="text-left">Химчистка ковриков (1шт.)</td>
            <td className="price">от 24</td>
            <td className="price" colSpan={4}>
              от 39
            </td>
          </tr>
          <tr>
            <td className="text-left">21</td>
            <td className="text-left">Локальная химчистка (удаление пятен)</td>
            <td className="price" colSpan={5}>
              от 33
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="text-left">
              Чистка кожи составами LE TECH одного сидения
            </td>
            <td className="price" colSpan={2}>
              72
            </td>
          ...
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ЗАЩИТА КОЖИ</strong>
            </td>
          </tr>
          <tr>
            <td className="text-left">1</td>
            <td className="text-left" colSpan={6}>
              Защитный керамический состав для кожи:
            </td>
          </tr>
          <tr>
            <td className="text-left">2</td>
          ...
          <tr>
            <td className="text-left">4</td>
            <td className="text-left">Дверная карта (1 шт.)</td>
          ...
          <tr>
            <td className="text-left">9</td>
            <td className="text-left">
              Защита текстиля керамическим составом:
            </td>
            <td className="price" colSpan={5}>
              {" "}
            </td>
          ...
          <tr>
            <td className="text-left">13</td>
            <td className="text-left">Напольное покрытие одного места</td>
            <td className="price" colSpan={2}>
              65
            </td>
            <td className="price" colSpan={2}>
          ...
          <tr className="price-table__section">
            <td colSpan={7}>
              ...
              <br />
              Итоговая стоимость может измениться от сложности работ и степени
              загрязнения
            </td>
          </tr>
          <tr className="price-table__section">
