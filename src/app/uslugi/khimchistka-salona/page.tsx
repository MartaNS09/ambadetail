...
export default function KhimchistkaSalonaPage() {
  ...
  useEffect(() => {
    document.title =
      "Химчистка салона авто в Витебске — цена, удаление запахов, сушка - Ambadetail";
    ...
    metaDescription.setAttribute(
      "content",
      "Детейлинг‑химчистка салона в Витебске: сиденья, ковры, потолок, багажник, удаление пятен и запахов. Актуальные цены по классам, аккуратная сушка и запись.",
    );
    ...
    metaKeywords.setAttribute(
      "content",
      "детейлинг Витебск, химчистка авто Витебск, чистка салона автомобиля, детейлинг химчистка, глубокая чистка авто, чистка салона авто, химчистка салона машины",
    );
    ...
    canonicalLink.setAttribute(
      "href",
      "https://ambadetail.vercel.app/uslugi/khimchistka-salona",
    );
    ...
    ogTitle.setAttribute(
      "content",
      "Химчистка салона авто в Витебске — цена, удаление запахов, сушка",
    );
    ...
    ogImage.setAttribute(
      "content",
      "https://ambadetail.vercel.app/images/services/salon.webp",
    );
