...
export default function LkpPage() {
  ...
  useEffect(() => {
    document.title =
      "Восстановление ЛКП в Витебске (Refiller F5) — цена и сроки - Ambadetail";
    ...
    metaDescription.setAttribute(
      "content",
      "Восстановление лакокрасочного покрытия авто в Витебске по технологии Refiller F5: актуальные цены по классам, сроки, рекомендации по защите результата. Запись в Ambadetail.",
    );
    ...
    metaKeywords.setAttribute(
      "content",
      "восстановление ЛКП Витебск, Refiller F5, цены восстановление ЛКП, восстановление лакокрасочного покрытия",
    );
    ...
    canonicalLink.setAttribute(
      "href",
      "https://ambadetail.vercel.app/uslugi/vosstanovlenie-lkp",
    );
    ...
    ogTitle.setAttribute(
      "content",
      "Восстановление ЛКП в Витебске (Refiller F5) — цена и сроки",
    );
    ...
    ogImage.setAttribute(
      "content",
      "https://ambadetail.vercel.app/images/services/bugatti.webp",
    );
