...
export default function OkleykaPage() {
  ...
  useEffect(() => {
    // Title
    document.title =
      "Оклейка авто плёнкой (PPF) в Витебске — цена и комплексы защиты - Ambadetail";
    ...
    metaDescription.setAttribute(
      "content",
      "Оклейка авто антигравийной (PPF) и цветной плёнкой в Витебске: частичная и полная защита кузова, фары, зоны риска. Актуальные цены по классам, гарантия и запись.",
    );
    ...
    metaKeywords.setAttribute(
      "content",
      "оклейка авто пленкой Витебск, защитная пленка на авто, цветная полиуретановая пленка на авто, смена цвета авто пленкой, бронирование кузова, антигравийная пленка, защита ЛКП автомобиля, полиуретановая пленка",
    );
    ...
    canonicalLink.setAttribute(
      "href",
      "https://ambadetail.vercel.app/uslugi/okleyka-auto-plenkoy",
    );
    ...
    ogTitle.setAttribute(
      "content",
      "Оклейка авто плёнкой (PPF) в Витебске — цена и комплексы защиты",
    );
    ...
    ogImage.setAttribute(
      "content",
      "https://ambadetail.vercel.app/images/services/vinil.webp",
    );
