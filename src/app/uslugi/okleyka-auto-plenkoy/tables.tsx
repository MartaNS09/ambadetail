...
// Футер для таблиц с примечаниями
const TableFooterWithNotes = () => (
  <div className="price-notes">
    <p>
      <strong>Примечания:</strong>
    </p>
    <ul>
      <li>— В стоимость включены арматурные работы.</li>
      <li>— Цена может измениться от сложности работ.</li>
      <li>— Наценка за мат или сатин +10%</li>
      <li>
        — Стоимость демонтажа пленки любой детали зависит от сложности
        выполнения работ
      </li>
      <li>— Porshe Macan и BMW 8 цена по запросу</li>
    </ul>
...
// Футер для таблицы брендов
const BrandsTableFooter = () => (
  <div className="price-notes">
    <p>Дополнительную информацию уточняйте у администраторов.</p>
    <Link href="/podarochnyy-sertifikat" className="btn btn--gift">
      Подарочный сертификат
      ...
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ОКЛЕЙКА ПЛЕНКОЙ SUNMAX | CRYSTALL</strong>
            </td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={2}>
              <strong>ПОЛНАЯ ОКЛЕЙКА</strong>
            </td>
            <td colSpan={5}> </td>
          </tr>
          <tr>
            <td className="text-left">1</td>
            <td className="text-left">Полная оклейка</td>
            <td className="price">7 370</td>
            <td className="price">7 804</td>
            <td className="price">8 237</td>
            <td className="price">9 538</td>
            <td className="price">10 405</td>
          </tr>
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">Полная оклейка (без крыши)</td>
            <td className="price">6 503</td>
            <td className="price">6 937</td>
            <td className="price">7 370</td>
            <td className="price">8 237</td>
            <td className="price">8 671</td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={2}>
              <strong>ЧАСТИЧНАЯ ОКЛЕЙКА</strong>
            </td>
            <td colSpan={5}> </td>
          </tr>
          <tr>
            ...
            <td className="text-left">
              <strong className="price__highlight">Комплекс MINI</strong>
              <br />
              Капот частично, полоса над лобовым стеклом, антиманикюр, торцы
              дверей.
            </td>
            <td className="price">от 660</td>
            <td className="price">от 660</td>
            <td className="price">от 660</td>
            <td className="price">от 660</td>
            <td className="price">от 660</td>
          ...
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">
              <strong className="price__highlight">Комплекс LITE</strong>
              <br />
              Капот частично, крылья частично, полоса над лобовым стеклом. фары
              +ПТФ, антиманикюр, торцы дверей.
            </td>
            <td className="price">от 880</td>
            <td className="price">от 880</td>
            <td className="price">от 880</td>
            <td className="price">от 880</td>
            <td className="price">от 880</td>
          ...
          <tr>
            ...
            <td className="text-left">
              <strong className="price__highlight">Комплекс LITE+</strong>
              <br />
              Капот частично, крылья частично, полоса над лобовым стеклом,
              стойки лобового стекла, фары+ПТФ, антиманикюр, торцы дверей, полка
              заднего бампера, внутренние пороги дверей.
            </td>
            <td className="price">от 1 375</td>
            <td className="price">от 1 375</td>
            <td className="price">от 1 375</td>
            <td className="price">от 1 375</td>
            <td className="price">от 1 375</td>
          ...
          <tr>
            ...
            <td className="text-left">
              <strong className="price__highlight">Комплекс STANDART</strong>
              <br />
              Капот целиком, крылья частично, полоса над лобовым стеклом, стойки
              лобового стекла, фары+ПТФ, антиманикюр, торцы дверей, пороги 4 шт,
              полка заднего бампера.
            </td>
            <td className="price">от 1 595</td>
            <td className="price">от 1 595</td>
            <td className="price">от 1 595</td>
            <td className="price">от 1 595</td>
            <td className="price">от 1 595</td>
          ...
          <tr>
            ...
            <td className="text-left">
              <strong className="price__highlight">Комплекс STANDART+</strong>
              <br />
              Капот целиком, крылья целиком, фары+ПТФ, полоса над лобовым
              стеклом, стойки лобового стекла, торцы дверей, антиманикюр, полка
              заднего бампера, внутренние пороги дверей.
            </td>
            <td className="price">от 2 145</td>
            <td className="price">от 2 145</td>
            <td className="price">от 2 145</td>
            <td className="price">от 2 145</td>
            <td className="price">от 2 145</td>
          ...
          <tr>
            ...
            <td className="text-left">
              <strong className="price__highlight">Комплекс PREMIUM</strong>
              <br />
              Капот целиком, крылья целиком, передний бампер, фары+ПТФ, зеркала,
              полоса над лобовым стеклом, стойки лобового стекла, торцы дверей,
              антиманикюр, полка заднего бампера, внутренние пороги дверей.
            </td>
            <td className="price">от 2 970</td>
            <td className="price">от 2 970</td>
            <td className="price">от 2 970</td>
            <td className="price">от 2 970</td>
            <td className="price">от 2 970</td>
          ...
          <tr>
            ...
            <td className="text-left">Передний или задний бампер</td>
            <td className="price">650</td>
            <td className="price">867</td>
            <td className="price">1 084</td>
            <td className="price">1 387</td>
            <td className="price">1 604</td>
          </tr>
          <tr>
            <td className="text-left">8</td>
            <td className="text-left">Стойки лобового стекла (2шт.)</td>
          ...
          <tr>
            ...
            <td className="text-left">Лобовое стекло</td>
          ...
          <tr>
            ...
            <td className="text-left">Капот</td>
            <td className="price">650</td>
            <td className="price">694</td>
            <td className="price">910</td>
            <td className="price">1 127</td>
            <td className="price">1 257</td>
          </tr>
          <tr>
            <td className="text-left">11</td>
            <td className="text-left">Полоса на капот (до 50 см)</td>
          ...
          <tr>
            ...
            <td className="text-left">Крыша</td>
            <td className="price">564</td>
            <td className="price">737</td>
            <td className="price">997</td>
            <td className="price">1 301</td>
            <td className="price">1 431</td>
          </tr>
          <tr>
            <td className="text-left">13</td>
            <td className="text-left">Бронь панорамы</td>
            <td className="price" colSpan={3}>
              650
            </td>
            <td className="price" colSpan={2}>
          ...
          <tr>
            ...
            <td className="text-left">Полоса на крышу</td>
            <td className="price" colSpan={5}>
              173
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Переднее крыло (1 шт.)</td>
          ...
          <tr>
            ...
            <td className="text-left">Заднее крыло (1 шт.)</td>
            <td className="price">564</td>
            <td className="price">694</td>
            <td className="price">824</td>
            <td className="price">954</td>
            <td className="price">1 084</td>
          </tr>
          <tr>
            <td className="text-left">17</td>
            <td className="text-left">
          ...
          <tr>
            ...
            <td className="text-left">Крышка багажника</td>
            <td className="price">173</td>
            <td className="price">260</td>
            <td className="price" colSpan={2}>
              390
          ...
          <tr>
            ...
            <td className="text-left">Передняя оптика</td>
            <td className="price" colSpan={5}>
              260
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Противотуманная оптика</td>
            <td className="price" colSpan={5}>
              65
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Дверь (1шт)</td>
          ...
          <tr>
            ...
            <td className="text-left">Порог внешний</td>
            <td className="price">173</td>
            <td className="price">260</td>
            <td className="price">347</td>
            <td className="price">434</td>
          ...
          <tr>
            ...
            <td className="text-left">Порог внутренний</td>
            <td className="price" colSpan={2}>
              43
            </td>
            <td className="price" colSpan={2}>
          ...
          <tr>
            ...
            <td className="text-left">Боковое зеркало (1шт)</td>
            <td className="price" colSpan={2}>
              173
            </td>
            <td className="price">65</td>
            <td className="price">87</td>
            <td className="price">130</td>
          </tr>
          <tr>
            <td className="text-left">25</td>
            <td className="text-left">Спойлер</td>
            <td className="price">130</td>
            <td className="price" colSpan={3}>
              260
            </td>
          ...
          <tr>
            ...
            <td className="text-left">Защита под ручки</td>
            <td className="price" colSpan={5}>
              65
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Расширитель арок (1шт)</td>
          ...
          <tr>
            ...
            <td className="text-left">Оклейка боковых стоек (1 сторона)</td>
            <td className="price" colSpan={5}>
              87
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Оклейка боковых стоек (2 стороны)</td>
            <td className="price" colSpan={5}>
              173
            </td>
          </tr>
          <tr>
            ...
            <td className="text-left">Оклейка салона</td>
            <td className="price" colSpan={5}>
              от 152
            </td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={7}>
              <strong>ДЕМОНТАЖ ПЛЕНКИ</strong>
            </td>
          </tr>
          <tr>
            <td className="text-left">1</td>
            <td className="text-left">Демонтаж пленки лобового стекла</td>
            <td className="price" colSpan={5}>
              217
            </td>
          </tr>
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">Демонтаж пленки любой детали</td>
            <td colSpan={5}>от 20 до 30 % от стоимости оклейки детали</td>
          </tr>
        </tbody>
      </table>
    </div>
    <TableFooterWithNotes />
  </div>
);
    ...
    <div className="table-responsive">
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ОКЛЕЙКА ПЛЕНКОЙ STEK</strong>
            </td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={2}>
          ...
          <tr>
            ...
            <td className="price">8 671</td>
            <td className="price">9 538</td>
            <td className="price">11 272</td>
            <td className="price">13 007</td>
            <td className="price">16 042</td>
          </tr>
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">Полная оклейка (без крыши)</td>
          ...
          <tr>
            ...
            <td className="text-left">
              Зоны риска:
              <br />
              бампер, капот, передние крылья, зеркала заднего вида, фары, стойки
            </td>
            <td className="price">5 636</td>
            <td className="price">6 287</td>
            <td className="price">6 937</td>
            <td className="price">7 587</td>
            <td className="price">8 021</td>
          </tr>
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">Передний или задний бампер</td>
            <td className="price">1 647</td>
            <td className="price">1 734</td>
            <td className="price">2 081</td>
            <td className="price">2 211</td>
            <td className="price">2 471</td>
          </tr>
          <tr>
            <td className="text-left">3</td>
            <td className="text-left">Стойки лобового стекла (2шт.)</td>
          ...
          <tr>
            <td className="text-left">5</td>
            <td className="text-left">Капот</td>
            <td className="price">1 517</td>
            <td className="price">1 647</td>
            <td className="price">1 951</td>
            <td className="price">2 168</td>
            <td className="price">2 341</td>
          </tr>
          <tr>
            <td className="text-left">6</td>
            <td className="text-left">Полоса на капот (до 50 см)</td>
          ...
          <tr>
            ...
            <td className="price">1 647</td>
            <td className="price">2 168</td>
            <td className="price">2 601</td>
            <td className="price">2 818</td>
          </tr>
          <tr>
            <td className="text-left">8</td>
            <td className="text-left">Полоса на крышу</td>
          ...
          <tr>
            ...
            <td className="price">867</td>
            <td className="price">1 084</td>
            <td className="price">1 170</td>
            <td className="price">1 301</td>
          </tr>
          <tr>
            <td className="text-left">10</td>
            <td className="text-left">Заднее крыло (1 шт.)</td>
            <td className="price">1 821</td>
            <td className="price">1 994</td>
            <td className="price">2 385</td>
            <td className="price" colSpan={2}>
              2 601
            </td>
          </tr>
          ...
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">Демонтаж пленки любой детали</td>
            <td colSpan={5}>от 15 до 30 % от стоимости оклейки детали</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div className="table-responsive">
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ОКЛЕЙКА ПЛЕНКОЙ Llumar</strong>
            </td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={2}>
          ...
          <tr>
            ...
            <td className="price">9 538</td>
            <td className="price">10 405</td>
            <td className="price">12 139</td>
            <td className="price">13 874</td>
          </tr>
          <tr className="price-table__section">
            <td colSpan={2}>
              <strong>ЧАСТИЧНАЯ ОКЛЕЙКА</strong>
    ...
    <div className="table-responsive">
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ОКЛЕЙКА ЦВЕТНОЙ ПОЛИУРЕТАНОВОЙ ПЛЕНКОЙ</strong>
              <br />
              <span className="price-table__note">
                Стоимость +30% к прайсу защитной пленки SUNMAX | CRYSTALL
              </span>
            </td>
          </tr>
          <tr className="price-table__section">
          ...
          <tr>
            <td className="text-left">1</td>
            <td className="text-left">Полная оклейка</td>
            <td className="price">9 581</td>
            <td className="price">10 145</td>
            <td className="price">10 708</td>
            <td className="price">12 399</td>
            <td className="price">13 527</td>
          </tr>
        </tbody>
      </table>
    </div>
