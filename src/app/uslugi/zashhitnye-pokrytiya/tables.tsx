      ...
      <table className="price-table price-table--dark">
        ...
        <tbody>
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>ЗАЩИТНОЕ ПОКРЫТИЕ ЛКП</strong>
            </td>
          </tr>
          <tr>
            <td className="text-left">1</td>
            <td className="text-left">
              Защитное покрытие керамикой «HENDLEX M3» (в 1 слой)
            </td>
          ...
          <tr>
            ...
            <td className="text-left">
              Защитное покрытие керамикой «HENDLEX M3» (в 2 слоя)
            </td>
          ...
          <tr>
            ...
            <td className="text-left">
              Защитное покрытие керамикой «HENDLEX M3» (в 3 слоя)
            </td>
          ...
          <tr>
            ...
            <td className="text-left">
              Защитное покрытие керамикой «HENDLEX M3» (в 4 слоя)
            </td>
          ...
          <tr>
            ...
            <td className="text-left">
              Дополнительный слой покрытия «HENDLEX M3»
            </td>
          ...
          <tr>
            ...
            <td className="text-left">Защитное покрытие керамикой НА ПЛЕНКУ</td>
            <td className="price">500</td>
            <td className="price">550</td>
            <td className="price">600</td>
            <td className="price">650</td>
          ...
          <tr className="price-table__brand-row">
            <td colSpan={7}>
              <strong>НАНО — АНТИ ДОЖДЬ</strong>
            </td>
          </tr>
          <tr>
            <td className="text-left">1</td>
            <td className="text-left">
              НАНО — защитная обработка лобового или заднего стекла
            </td>
          ...
          <tr>
            <td className="text-left">2</td>
            <td className="text-left">
              НАНО — защитная обработка передней полусферы
            </td>
            <td className="price" colSpan={2}>
              174
            </td>
          ...
          <tr>
            <td className="text-left">3</td>
            <td className="text-left">
              НАНО — защитная обработка всех стёкол, зеркал, фар
            </td>
            <td className="price" colSpan={2}>
              260
            </td>
          ...
          <tr>
            <td className="text-left">4</td>
            <td className="text-left">
              НАНО — защитная обработка крыши панорамы
            </td>
            <td className="price" colSpan={2}>
              130
            </td>
